...
import com.chat.chatapp.ModelClass.Users;
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if(imageUri!=null)
                                {
                                    ...
                                    String staus="Hey There I'm Using This Application";
                                    imageURI="https://firebasestorage.googleapis.com/v0/b/vchat-9182b.appspot.com/o/client.jpg?alt=media&token=8cd580de-043f-42c4-8784-2212fd656089";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,staus);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
